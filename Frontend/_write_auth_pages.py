...
LOGIN = r'''import { useNavigate, Link, useLocation } from 'react-router-dom';
...
SIGNUP = r'''import { useNavigate, Link } from 'react-router-dom';
import { motion } from 'framer-motion';
...
base = r'c:\Users\adity\Desktop\CloudSpire\src\pages'
with open(os.path.join(base, 'Login.jsx'), 'w', encoding='utf-8') as f:
    f.write(LOGIN)
with open(os.path.join(base, 'Signup.jsx'), 'w', encoding='utf-8') as f:
    f.write(SIGNUP)
print('Done')
