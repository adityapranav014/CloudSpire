...
export const gcpProjects = [
  { id: "my-prod-project-001", name: "Production Platform", billingAccountId: "01A2B3-C4D5E6-F7G8H9", spend: 39100, env: "production", resources: 112 },
  { id: "data-analytics-prod-002", name: "Data Analytics", billingAccountId: "01A2B3-C4D5E6-F7G8H9", spend: 12400, env: "production", resources: 28 },
  { id: "ml-research-003", name: "ML Research", billingAccountId: "01A2B3-C4D5E6-F7G8H9", spend: 8700, env: "staging", resources: 19 },
  { id: "dev-sandbox-004", name: "Dev Sandbox", billingAccountId: "01A2B3-C4D5E6-F7G8H9", spend: 3200, env: "development", resources: 8 },
];
